...
Luis Guiovani- Tienne una muy buena logica para la resolución de problemas y maneja buenas practicas a la hora de nombrar y crear variables. Es capaz de identificar rapidamente la problematica que se le presenta y aplicar sus conocimientos, tiene aspectos a mejorar como su velcoidad y algunas funciones, pero en general posee muy buenas caracteristicas para este puesto. 